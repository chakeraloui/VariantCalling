rule multiqc:
    input:
        ...
        trimming1 = expand("aligned_reads/{sample}_1.fastq.gz_trimming_report.txt", sample = SAMPLES),
        trimming2 = expand("aligned_reads/{sample}_2.fastq.gz_trimming_report.txt", sample = SAMPLES)
    output:
